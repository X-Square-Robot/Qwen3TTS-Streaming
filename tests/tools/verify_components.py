...
Usage (from repo root, conda activate qwen3-tts):
  python tests/tools/verify_components.py --component code2wav [options]
  python tests/tools/verify_components.py --component speech-tokenizer [options]
  python tests/tools/verify_components.py --component precision-ort --onnx ... --ref ...
  python tests/tools/verify_components.py --component prototype-parity --text "你好" [options]
"""
