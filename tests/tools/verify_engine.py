...
Usage examples:
  python tests/tools/verify_engine.py --phase e2e --variant design-1.7b --steps 10
  python tests/tools/verify_engine.py --phase e2e-trt --model-dir workspace/exported/design-1.7b
  python tests/tools/verify_engine.py --phase e2e-trt-ref --variant design-1.7b --steps 50
  python tests/tools/verify_engine.py --phase fused-triton --variant custom-1.7b --text "Hello"
  python tests/tools/verify_engine.py --phase onnx-autoregressive --dump-dir /dumps --onnx model.onnx
  python tests/tools/verify_engine.py --phase code-predictor --variant-dir workspace/exported/custom-1.7b
  python tests/tools/verify_engine.py --phase trt-talker --variant design-1.7b
  python tests/tools/verify_engine.py --phase multi-variant --size 1.7b
"""
...
def _print_deprecation(phase: str, old_script: str) -> None:
    ...
    print(
        ...
        f"Use: python tests/tools/verify_engine.py --phase {phase} ...",
        file=sys.stderr,
    )
