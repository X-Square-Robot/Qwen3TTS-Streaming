...
Usage:
  python tests/tools/compare_audio.py <mode> [options]
  python tests/tools/compare_audio.py gen-triton
  python tests/tools/compare_audio.py compare-triton --text "你好" --speaker serena
  python tests/tools/compare_audio.py --help
"""
...
try:
    from tests.tools._bootstrap import bootstrap_tool_imports as _bootstrap_tool_imports
except ImportError:
    from _bootstrap import bootstrap_tool_imports as _bootstrap_tool_imports

_bootstrap_tool_imports()
