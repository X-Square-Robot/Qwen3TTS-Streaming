...
class TTSEngine:
    ...
    async def start(self) -> None:
        ...
        self._frontend = FrontendInterface(
            ...
            safety_ratio_initial=sc.safety_ratio_initial,
            ...
            ema_min_observation_tokens=sc.ema_min_observation_tokens,
            safety_failure_multiplier=sc.safety_failure_multiplier,
        ...
        self._engine_loop = EngineLoop(
            ...
            token_loop_suspect_frames=sched.token_loop_suspect_frames,
            token_loop_abort_frames=sched.token_loop_abort_frames,
            token_loop_min_audio_text_ratio=(sched.token_loop_min_audio_text_ratio),
            token_loop_emergency_abort_frames=(sched.token_loop_emergency_abort_frames),
