...
本项目目前处于 **v0.2 稳定性版本**阶段，仅对 `main` 分支的最新提交提供安全修复。已验证
checkpoint 已大幅降低跑飞型幻觉，但运营方仍应阅读[已知限制](docs/user/known_limitations.zh-CN.md)
并按自己的业务负载完成验收。
...
部署相关的安全须知（鉴权、网络暴露面等）见 [部署指南](docs/user/deployment.zh-CN.md)。
