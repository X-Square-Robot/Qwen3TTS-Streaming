...
| [原生游标、TRT 融合与流式 TN 坐标投影](architecture/native_cursor_trt_fusion_decision.zh-CN.md) | 原生游标的 TRT 图合同、能力路由、主 TN 到 raw 坐标的投影边界 |
...
| [流式文本消歧与 Soft Drain](design/incremental_text_normalization_and_soft_drain.zh-CN.md) | 已落地的增量 TN、单调提交、当前 WAIT_TEXT，以及尚未发布的 Soft Drain 和状态继承设计 |
