...
**2026-07-07/08** on the round-3 engine build (includes `b80cf45`/`2a9578b`/`a8e7274` plus
`cc58c6a`/`8596996`/`b80c38d`); `triton-grpc` rows are **retained from the 2026-07-06 dataset**,
whose engine core predates all of those commits — they overstate current Triton latency and are
kept as the last measured reference.
...
- `summary.csv` — avg/p50/p90/p99/max per (protocol, concurrency level) and (protocol, connection mode), pooled across **all 6 trials** (3 engine-side 2026-07-07/08 + 3 Triton-side 2026-07-06; 51,981 requests total, 0 failures).
