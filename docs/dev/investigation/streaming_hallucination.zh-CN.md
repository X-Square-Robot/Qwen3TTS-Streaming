[English](streaming_hallucination.md) | **中文**

# 流式幻觉调查总结

> **当前 v0.2 状态（2026-09-10）：** 下文 10–18% 跑飞率描述的是历史内部 0601
> checkpoint，不代表当前发布质量。已验证的重训/当前 checkpoint 在全 bf16 引擎确定性
> 探针上记录为跑飞 0/100。旧数据应作为根因证据保留，但 v0.2 对外应描述为已经大幅
> 抑制该问题，而不是继承 0601 的比例。
