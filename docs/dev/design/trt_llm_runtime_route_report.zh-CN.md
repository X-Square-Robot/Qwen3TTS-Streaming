[English](trt_llm_runtime_route_report.md) | **中文**
...
项目当前 `docs/roadmap.zh-CN.md` 明确表述的重点仍然是稳定性、部署和可维护性，因此路线选择应优先考虑产品化成本，而不是理论上的最高性能。
...
- `docs/dev/architecture/engine_decisions.zh-CN.md`
- `docs/dev/design/mixed_precision_plan.zh-CN.md`
