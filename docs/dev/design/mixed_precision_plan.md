...
本方案的核心动机来自 `docs/dev/investigation/streaming_hallucination.md` 的系统化调查。关键发现如下：
...
- 重点验证 `docs/dev/investigation/streaming_hallucination.md` 中已记录的不良转储步骤 `000003`、`000004`、`000008`
...
- 参考 `streaming_hallucination.md` 发现 #18：强制 `hidden/logits` 为 fp32 也改变了 TRT 数值，需关注这种交互效应
